...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hiddent_weight = nn.Parameter(torch.Tensor(self.n_features * self.embed_size, self.hidden_size))
        nn.init.xavier_uniform_(self.embed_to_hiddent_weight)
    ...
    def forward(self, w):
        ...
        h = torch.nn.functional.relu(torch.matmul(x, self.embed_to_hiddent_weight) + self.embed_to_hidden_bias)
        h = self.dropout(h)
